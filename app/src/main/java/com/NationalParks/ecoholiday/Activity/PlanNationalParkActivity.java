...
public class PlanNationalParkActivity extends AppCompatActivity {
...
//        getSupportActionBar().setDisplayShowHomeEnabled(true);
        ...
        btnCamping.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ParkCampingFacilityList.size()>0) {
                    final Dialog dialog1 = new Dialog(PlanNationalParkActivity.this);
                    ...
                    parkFacilityAdapter = new ParkFacilityAdapter(PlanNationalParkActivity.this, ParkCampingFacilityList);
        ...
        btnTrekking.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(ParkTrekkingFacilityList.size()>0) {
                    final Dialog dialog = new Dialog(PlanNationalParkActivity.this);
                    dialog.setContentView(R.layout.custom_dailog);
                    dialog.setTitle(parkName);
                    TrekkingData = (ListView) dialog.findViewById(R.id.List);
                    parkFacilityAdapter = new ParkFacilityAdapter(PlanNationalParkActivity.this, ParkTrekkingFacilityList);
    ...
    private class GetParksFacilityData extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pDialog = new ProgressDialog(PlanNationalParkActivity.this);
